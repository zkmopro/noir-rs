...
/// Flatten chunked proof fields (Vec<Vec<u8>>) into a flat byte vector.
...
/// Split a flat byte vector into 32-byte field elements.
...
/// Check if slow low memory mode is currently enabled.
pub fn get_slow_low_memory() -> bool {
    unsafe { slow_low_memory }
}
