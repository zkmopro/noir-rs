...
/// Split a proof byte vector into public_inputs and proof fields.
///
/// Expected format: [num_public_inputs (4 bytes BE)] [public_input fields] [proof fields]
...
pub fn get_ultra_honk_verification_key(
    ...
    configure_memory(low_memory_mode, None);
